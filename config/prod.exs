...
config :melodica_inventory, MelodicaInventory.Endpoint,
  ...
  url: [scheme: "https", host: "melodika-inventory.herokuapp.com", port: 443],
...
config :melodica_inventory, HelloPhoenix.Repo,
...
# start per endpoint:
#
#     config :melodica_inventory, MelodicaInventory.Endpoint, server: true
#
